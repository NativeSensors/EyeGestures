...
class EyeGestures_v3:
    ...
    def step(self, frame, calibration, width, height, context="main"):
        ...
        gevent = Gevent(point=averaged_point, blink=blink, fixation=fixation, saccades=saccades, sub_frame=sub_frame)
        cevent = Cevent(
...
class EyeGestures_v1:
    ...
    def __init__(self, roi_x=225, roi_y=105, roi_width=80, roi_height=15):
        ...
        self.gaze = GazeTracker(screen_width, screen_height, width, height, roi_x, roi_y, roi_width, roi_height)
    ...
    def step(
        ...
        event = self.gaze.estimate(
            image, display, context, calibration, fixation_freeze, freeze_radius, offset_x, offset_y
        )
        cevent = None
