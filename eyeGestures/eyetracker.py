...
class CalibrationCollector:
    ...
    def __init__(self, width, height, time, points):
        self.calibrationTimeLimit = time #s
        self.calibrationPeriod = int(time/points) # s
        self.__start = False
...
class CalibrationDisplay:
    ...
    def drawPoint(self, point, colour, name=""):
        print(f"[{name}] printing: {int(point[0]*self.width)} {int(point[1]*self.height)}")
